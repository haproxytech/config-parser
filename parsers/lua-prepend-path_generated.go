...
func (p *LuaPrependPath) Delete(index int) error {
	...
	p.data[len(p.data)-1] = types.LuaPrependPath{}
...
func (p *LuaPrependPath) Insert(data common.ParserData, index int) error {
	...
	case *types.LuaPrependPath:
		if index > -1 {
			...
			p.data = append(p.data, types.LuaPrependPath{})
...
func (p *LuaPrependPath) PreParse(line string, parts, previousParts []string, preComments []string, comment string) (changeState string, err error) {
...
func (p *LuaPrependPath) Parse(line string, parts, previousParts []string, comment string) (changeState string, err error) {
