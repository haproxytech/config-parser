...
func (p *LuaPrependPath) PreParse(line string, parts []string, preComments []string, comment string) (changeState string, err error) {
...
func (p *LuaPrependPath) Parse(line string, parts []string, comment string) (changeState string, err error) {
