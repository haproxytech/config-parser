...
func (p *LoadServerStateFromFile) Set(data common.ParserData, index int) error {
	...
	case *types.LoadServerStateFromFile:
		p.data = newValue
	case types.LoadServerStateFromFile:
		p.data = &newValue
	default:
...
func (p *LoadServerStateFromFile) PreParse(line string, parts, previousParts []string, preComments []string, comment string) (changeState string, err error) {
