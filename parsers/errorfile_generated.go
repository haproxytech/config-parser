...
func (p *ErrorFile) PreParse(line string, parts []string, preComments []string, comment string) (changeState string, err error) {
...
func (p *ErrorFile) Parse(line string, parts []string, comment string) (changeState string, err error) {
