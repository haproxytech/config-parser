...
func (p *H1CaseAdjust) PreParse(line string, parts []string, preComments []string, comment string) (changeState string, err error) {
...
func (p *H1CaseAdjust) Parse(line string, parts []string, comment string) (changeState string, err error) {
