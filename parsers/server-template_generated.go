...
func (p *ServerTemplate) PreParse(line string, parts []string, preComments []string, comment string) (changeState string, err error) {
...
func (p *ServerTemplate) Parse(line string, parts []string, comment string) (changeState string, err error) {
