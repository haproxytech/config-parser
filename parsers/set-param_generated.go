...
func (p *SetParam) Delete(index int) error {
	...
	p.data[len(p.data)-1] = types.SetParam{}
...
func (p *SetParam) Insert(data common.ParserData, index int) error {
	...
	case *types.SetParam:
		if index > -1 {
			...
			p.data = append(p.data, types.SetParam{})
...
func (p *SetParam) PreParse(line string, parts []string, preComments []string, comment string) (changeState string, err error) {
