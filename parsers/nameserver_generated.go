...
func (p *Nameserver) PreParse(line string, parts []string, preComments []string, comment string) (changeState string, err error) {
...
func (p *Nameserver) Parse(line string, parts []string, comment string) (changeState string, err error) {
