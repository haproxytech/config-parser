...
func (p *configParser) getGlobalParser() *Parsers {
	...
	addParser(parser, &sequence, &simple.Number{Name: "tune.tune.buffers.limit"})
	addParser(parser, &sequence, &simple.Number{Name: "tune.tune.buffers.reserve"})
	addParser(parser, &sequence, &simple.Number{Name: "tune.bufsize"})
	addParser(parser, &sequence, &simple.Number{Name: "tune.comp.maxlevel"})
	addParser(parser, &sequence, &simple.Word{Name: "tune.fail-alloc"})
	...
	addParser(parser, &sequence, &simple.Word{Name: "tune.lua.maxmem"})
	...
	addParser(parser, &sequence, &simple.Number{Name: "tune.rcvbuf.recv_enough"})
	...
	addParser(parser, &sequence, &simple.Word{Name: "tune.ssl.force-private-cache"})
