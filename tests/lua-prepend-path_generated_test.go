...
func TestLuaPrependPath(t *testing.T) {
	tests := map[string]bool{
		"lua-prepend-path /usr/share/haproxy-lua/?/init.lua":       true,
		"lua-prepend-path /usr/share/haproxy-lua/?/init.lua cpath": true,
		"lua-prepend-path": false,
		"---":              false,
		"--- ---":          false,
	}
	parser := &parsers.LuaPrependPath{}
