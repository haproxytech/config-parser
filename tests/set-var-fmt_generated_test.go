...
func TestSetVarFmt(t *testing.T) {
	tests := map[string]bool{
		`set-var-fmt proc.current_state "primary"`: true,
		`set-var-fmt proc.bootid "%pid|%t"`:        true,
		"set-var-fmt":                              false,
		"set-var-fmt name":                         false,
		"---":                                      false,
		"--- ---":                                  false,
	}
	parser := &parsers.SetVarFmt{}
