...
func TestProcessVary(t *testing.T) {
	tests := map[string]bool{
		"process-vary on":      true,
		"process-vary off":     true,
		"process-vary enabled": false,
		"process-vary":         false,
		"process-vary on off":  false,
		"---":                  false,
		"--- ---":              false,
	}
	parser := &parsers.ProcessVary{}
