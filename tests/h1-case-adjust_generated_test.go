...
func TestH1CaseAdjust(t *testing.T) {
	tests := map[string]bool{
		"h1-case-adjust content-type Content-Type": true,
		"h1-case-adjust":                           false,
		"h1-case-adjust content-type":              false,
		"h1-case-adjust content-type Content Type": false,
		"---":     false,
		"--- ---": false,
	}
	parser := &parsers.H1CaseAdjust{}
