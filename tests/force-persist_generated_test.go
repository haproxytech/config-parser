...
func TestForcePersist(t *testing.T) {
	tests := map[string]bool{
		"force-persist if acl-name":     true,
		"force-persist unless acl-name": true,
		"force-persist":                 false,
		"force-persist if":              false,
		"force-persist ddd acl-name":    false,
		"force-persist acl-name":        false,
		"---":                           false,
		"--- ---":                       false,
	}
	parser := &parsers.ForcePersist{}
