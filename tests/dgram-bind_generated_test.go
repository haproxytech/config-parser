...
func TestDgramBind(t *testing.T) {
	tests := map[string]bool{
		"dgram-bind :80,:443":                      true,
		"dgram-bind 10.0.0.1:10080,10.0.0.1:10443": true,
		"dgram-bind :443 interface eth0":           true,
		"dgram-bind :443 interface eth1":           true,
		"dgram-bind :443 interface pppoe-wan":      true,
